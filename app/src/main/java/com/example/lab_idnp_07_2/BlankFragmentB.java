...
public class BlankFragmentB extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_blank_b, container, false);
        textRes=v.findViewById(R.id.textViewRestaurante);getParentFragmentManager().setFragmentResultListener("dataFrom1", this, new FragmentResultListener() {
            @Override
            public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
                String data=result.getString("restaurante");
                textRes.setText("");
                textRes.setText(data);
            }
        });
        return v;
    }
